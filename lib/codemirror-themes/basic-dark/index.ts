...
const basicDark = (alpha: string | number) => {
  /// The editor theme styles for Basic Dark.
  const base00 = `rgba(46, 50, 53, ${alpha})`,
    base01 = '#DDDDDD',
    base02 = '#B9D2FF',
    base03 = '#b0b0b0',
    base04 = '#d0d0d0',
  ...
  const basicDarkThemesArray = [theme, syntaxHighlighting(basicDarkHighlightStyle)]
  return basicDarkThemesArray as Extension
}


/// Extension to enable the Basic Dark theme (both the editor theme and
/// the highlight style).
// export const basicDarks: Extension = basicDark
