  ...
  return (
    <style>
      {`
          ...
          .CodeMirror-cursor {
            // border-left: 1px solid var(--cp-color-20);
            border-right: none;
            width: 0;
          }
          ...
          @-moz-keyframes CodeEditor_blink-33-CH {
            50% {
              background-color: transparent;
            }
          }
          @-webkit-keyframes CodeEditor_blink-33-CH {
            50% {
              background-color: transparent;
            }
          }
          @keyframes CodeEditor_blink-33-CH {
            50% {
              background-color: transparent;
            }
          }
          ...
          .CodeMirror-dialog-top button:focus,
          .CodeMirror-dialog-top button:hover {
          ...
          .CodeEditor_firepad-3qrvi .CodeMirror-hints .CodeMirror {
            position: relative;
          }
          ...
          .CodeEditor_textarea-1ElF3:focus,
          .CodeEditor_textarea-1ElF3:hover {
            background: 0 0;
          }
        `}
    </style>
...
export default CodeMirrorInlineStyle;
