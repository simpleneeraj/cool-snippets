...
export default function FluentEmojiRobot(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      <g fill="none">
        ...
        <defs>
          ...
          <linearGradient
            ...
            gradientUnits="userSpaceOnUse"
          >
            <stop offset={0.006} stopColor="#443e75"></stop>
          ...
          <linearGradient
            ...
            gradientUnits="userSpaceOnUse"
          >
            <stop offset={0.006} stopColor="#39325e"></stop>
          ...
          >
            ...
            <stop offset={0.493} stopColor="#d1bee3"></stop>
          ...
          >
            ...
            <stop offset={0.441} stopColor="#ff2455"></stop>
          ...
          <radialGradient
            ...
            gradientUnits="userSpaceOnUse"
          >
            <stop offset={0.431} stopColor="#ca7e29" stopOpacity={0}></stop>
