...
export function BitcoinIconsMagicWandFilled(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="m7.999 20l7-7.003a2.822 2.822 0 0 0-3.99-3.993l-7.007 6.997a2.827 2.827 0 1 0 3.997 4M11 11l2 2l1-1a1.414 1.414 0 1 0-2-2z"
        clipRule="evenodd"
      ></path>
      <path
        fill="currentColor"
