  ...
  return (
    <UIView className="scheme-dark">
      <UIView className="relative">
        ...
        />
        <UIView
          className="absolute inset-0 -z-10 bg-position-[35%_bottom] bg-no-repeat mix-blend-screen sm:bg-position-[38%_bottom] md:bg-position-[40%_bottom] lg:bg-position-[44%_bottom] xl:bg-bottom forced-colors:hidden"
          style={{
          ...
          <UIView className="relative">
            ...
            <UIView className="px-2 pb-8">
              <UIView className="mt-2 grid grid-cols-1 gap-x-8 gap-y-14 sm:grid-cols-2 lg:grid-cols-3">
                {list.map((item) => (
                  <a key={item.img} className="group focus:outline-hidden">
