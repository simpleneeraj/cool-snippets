...
export enum Key {
  ...
  /**
   * The numeric keypad's 1 key.
   */
  One = '1',

  /**
   * The numeric keypad's 2 key.
   */
  Two = '2',

  /**
   * The numeric keypad's 3 key.
   */
  Three = '3',

  /**
   * The numeric keypad's 4 key.
   */
  Four = '4',

  /**
   * The numeric keypad's 5 key.
   */
  Five = '5',

  /**
   * The numeric keypad's 6 key.
   */
  Six = '6',

  /**
   * The numeric keypad's 7 key.
   */
  Seven = '7',

  /**
   * The numeric keypad's 8 key.
   */
  Eight = '8',

  /**
   * The numeric keypad's 9 key.
   */
  Nine = '9',
  /**
   * The numeric keypad's 0 key.
   */
  Zero = '0',
  /**
   * The numeric keypad's plus key (+).
   */
  Plus = '+',
  /**
   * The numeric keypad's minus key (-).
   */
  Minus = '-',
  /**
   * The numeric keypad's equals key (=).
   */
  Equals = '=',
}
